...
require_once($CFG->dirroot.'/local/compile/mod/forum/lib.php');
...
switch ($forum->type) {
    ...
    default:
        ...
        echo '<br />';
        if (!empty($showall)) {
            compile_forum_print_latest_discussions($course, $forum, 0, 'header', '', -1, -1, -1, 0, $cm);
        } else {
            compile_forum_print_latest_discussions($course, $forum, -1, 'header', '', -1, -1, $page, $CFG->forum_manydiscussions, $cm);
        }
