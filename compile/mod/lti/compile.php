...
/**
 * Compile LTI (External Tool) module
 *
...
$modname = 'lti'; // Set to the name of the module.
...
// Output module content: Launch (Tool) URL.
$toolurl = $instance->toolurl;
print get_string('lti_url', 'local_compile', $toolurl);
